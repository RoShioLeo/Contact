...
public class PostcardStyleArgument extends ResourceLocationArgument
{
    ...
    private static final DynamicCommandExceptionType POSTCARD_STYLE_NOT_FOUND = new DynamicCommandExceptionType(name -> Component.translatable("command.contact.style_not_found", name));
