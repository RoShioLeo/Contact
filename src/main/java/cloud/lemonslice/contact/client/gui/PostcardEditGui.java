...
public class PostcardEditGui extends Screen
{
    ...
    public PostcardEditGui(ItemStack postcardIn, Player playerIn, InteractionHand handIn)
    {
        ...
        this.textBox = this.addWidget(new EditableTextBox(postcard, editingPlayer, hand, (this.width - style.cardWidth) / 2 + style.textPosX, (this.height / 2 - style.cardHeight * 2 / 3) + style.textPosY, style.textWidth, style.textHeight, 12, style.textColor, Component.literal("Postcard")));
    }
