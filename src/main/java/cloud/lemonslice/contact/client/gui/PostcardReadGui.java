...
public class PostcardReadGui extends Screen
{
    ...
    protected void init()
    {
        this.textBox = new ReadOnlyTextBox(postcard, (this.width - style.cardWidth) / 2 + style.textPosX, style.textPosY + (this.height - style.cardHeight) / 2, style.textWidth, style.textHeight, 12, style.textColor, new TextComponent("Postcard"));
    }
