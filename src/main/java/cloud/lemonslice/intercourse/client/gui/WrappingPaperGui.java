...
public class WrappingPaperGui extends ContainerScreen<WrappingPaperContainer>
{
    ...
    protected void init()
    {
        ...
        this.buttonPack = new IconButton(offsetX + 124, offsetY + 15, 18, 19, new TranslationTextComponent("tooltip.intercourse.wrapping_paper.pack"), button -> pack(), this::buttonTooltip);
