...
import cloud.lemonslice.intercourse.network.EnquireAddresseeMessage;
...
public class PostboxGui extends ContainerScreen<PostboxContainer>
{
    ...
    protected void init()
    {
        ...
        this.buttonSend = new IconButton(offsetX + 97, offsetY + 26, 10, 9, new TranslationTextComponent("tooltip.intercourse.postbox.send"), button -> send(), this::buttonTooltip);
        this.children.add(this.buttonSend);

        this.minecraft.keyboardListener.enableRepeatEvents(true);
        this.nameField = new TextFieldWidget(this.font, offsetX + 42, offsetY + 26, 43, 9, new TranslationTextComponent("info.intercourse.postbox.addressee"));
    ...
    private void buttonTooltip(Button button, MatrixStack matrixStack, int mouseX, int mouseY)
    {
        if (button.isHovered())
        {
            ...
            {
                GuiHelper.drawTooltip(this, matrixStack, mouseX, mouseY, button.x, button.y, button.getWidth(), button.getHeight(), Lists.newArrayList(new TranslationTextComponent("tooltip.intercourse.postbox.enquire")));
            }
        }
    }
    ...
    {
        this.font.drawText(matrixStack, new TranslationTextComponent("info.intercourse.postbox.addressee"), 40, 14, 0xE6E6E6);
        switch (container.status)
        {
            case 0:
            {
                TranslationTextComponent text = new TranslationTextComponent("info.intercourse.postbox.need_mail");
            ...
            case 2:
            {
                TranslationTextComponent text = new TranslationTextComponent("info.intercourse.postbox.estimated");
                int width = this.font.getStringWidth(text.getString());
                ...
                if (width > 38)
                {
                    ...
                    if (container.time == 0)
                    {
                        this.font.drawText(matrixStack, new TranslationTextComponent("info.intercourse.postbox.instant"), 141 - width / 2, 22, 0x1A1A1A);
                    }
                    else
                    {
                        this.font.drawText(matrixStack, new TranslationTextComponent("info.intercourse.postbox.time", min, sec), 141 - width / 2, 22, 0x1A1A1A);
                    }
                }
                else
                {
                    ...
                    if (container.time == 0)
                    {
                        this.font.drawText(matrixStack, new TranslationTextComponent("info.intercourse.postbox.instant"), 122, 22, 0x1A1A1A);
                    }
                    else
                    {
                        this.font.drawText(matrixStack, new TranslationTextComponent("info.intercourse.postbox.time", min, sec), 122, 22, 0x1A1A1A);
                    }
                }
                return;
            }
            case 3:
            {
                TranslationTextComponent text = new TranslationTextComponent("info.intercourse.postbox.not_found");
                int width = this.font.getStringWidth(text.getString());
                if (width > 38)
                {
            ...
            case 4:
            {
                TranslationTextComponent text = new TranslationTextComponent("info.intercourse.postbox.full_mail");
                int width = this.font.getStringWidth(text.getString());
                if (width > 38)
                {
                    List<IReorderingProcessor> list = this.font.trimStringToWidth(text, 50);
            ...
            case 5:
            {
                TranslationTextComponent text = new TranslationTextComponent("info.intercourse.postbox.success");
                int width = this.font.getStringWidth(text.getString());
                if (width > 38)
                {
                    List<IReorderingProcessor> list = this.font.trimStringToWidth(text, 50);
